...
namespace AIS_Driving_School_Driver_
{
    public partial class Curators_Add : Form
    {
        ...
        class Dobavlenue
        {
            ...
            public void Add_Function(ComboBox comboBox1, ComboBox comboBox2, ComboBox comboBox3, TextBox textBox2, TextBox textBox3, TextBox textBox4)
            {

                conn.Open();
                try
                {
                    string sql = "INSERT INTO Curators (FIO, Grups, Cabinet, Adres, Phone, Mail) VALUES ('" + comboBox1.Text + "', '" + comboBox2.Text + "', '" + comboBox3.Text + "', '" + textBox2.Text + "', '" + textBox3.Text + "', '" + textBox4.Text + "')";
            ...
            // Заполнение combobox3 Кабинет
            public void GetList3(string id_cp, Label label8)
            {
                //Открываем соединение
                conn.Open();
                //Строка запроса
        ...
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            dobavlenue_inf.GetList2(id_cpu_selected, label8);
        }

        private void button1_Click(object sender, EventArgs e)
        {
            dobavlenue_inf.Add_Function(comboBox1, comboBox2, comboBox3, textBox2, textBox3, textBox4);
        }
        ...
        private void comboBox3_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            dobavlenue_inf.GetList3(id_cpu_selected, label8);
        }
    }
}
