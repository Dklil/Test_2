...
{
    public partial class Add_Weekly_schedule_Ivanova_Maui_Nikitigna : Form
    {
        public Add_Weekly_schedule_Ivanova_Maui_Nikitigna()
        {
            InitializeComponent();
        ...
        class Dobavlenue
        {
            ...
            public void Add_Function(TextBox textBox1, TextBox textBox2, TextBox textBox3, ComboBox comboBox1, ComboBox comboBox2)
            {
                ...
                try
                {
                    string sql = "INSERT INTO Teacher_Ivanova_Maui_Nikitigna (Number_day,Day, Time_day, Grup, Cabinet) VALUES ('" + textBox1.Text + "', '" + textBox2.Text + "', '" + textBox3.Text + "', '" + comboBox1.Text + "', '" + comboBox2.Text + "')";
        ...
        private void Add_Weekly_schedule_Ivanova_Maui_Nikitigna_Load(object sender, EventArgs e)
        {
