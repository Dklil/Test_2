...
namespace AIS_Driving_School_Driver_
{
    public partial class Teacher_Add : Form
    {
        ...
        class inf_dobav
        {
            ...
            public void Dobavlenue(TextBox textBox1, ComboBox comboBox1, ComboBox comboBox2, ComboBox comboBox3,TextBox textBox4, TextBox textBox5, TextBox textBox6)
            {           
                conn.Open();
                try
                {
                    string sql = "INSERT INTO Teachers (FIO, Curators, Grupa, Car, Adres, Phone, Mail) VALUES ('" + textBox1.Text + "', '" + comboBox1.Text + "', '" + comboBox2.Text + "', '" + comboBox3.Text + "', '" + textBox4.Text + "', '" + textBox5.Text + "', '" + textBox6.Text + "')";
        ...
        {
            inf_do.GetComboBoxList1(comboBox1);
        ...
        {
            inf_do.Dobavlenue(textBox1, comboBox1, comboBox2, comboBox3, textBox4, textBox5, textBox6);
        }
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            inf_do.GetList1(id_cpu_selected, label7);
        }
