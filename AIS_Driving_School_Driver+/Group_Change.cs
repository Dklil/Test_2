...
namespace AIS_Driving_School_Driver_
{
    public partial class Group_Change : Form
    {
        ...
        class Change_Inform
        {
            ...
            public void GetList(TextBox textBox1, ComboBox comboBox1, ComboBox comboBox2)
            {
            ...
            public void CName(TextBox textBox1, ComboBox comboBox1, ComboBox comboBox2 )
            {
                string connStr = "server = chuc.caseum.ru; user = st_2_18_4; database = is_2_18_st4_VKR; password = 75855345; port = 33333";
                MySqlConnection conn = new MySqlConnection(connStr);
                string sql = "UPDATE Grups SET Name= '" + textBox1.Text + "', Kategoria= '" + comboBox1.Text + "', Teacher= '" + comboBox2.Text + "' WHERE id = " + lell.id;
        ...
        private void Group_Change_Load(object sender, EventArgs e)
        {
            ...
            change_Inform.GetList(textBox1, comboBox1, comboBox2);
        ...
        {
            change_Inform.CName(textBox1, comboBox1, comboBox2);
        }
